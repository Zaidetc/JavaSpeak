...
function textToSpeech(text) {
    ...
    const chosenVoice = voices.find(voice => voice.name === 'Microsoft Ravi - English (India)');
      ...
      function update() {
          if (!isDragging) {
              ...
              if (posX <= 0 || posX + logo.clientWidth >= window.innerWidth) {
                  velX *= -1;
                  posX = Math.min(Math.max(posX, 0), window.innerWidth - logo.clientWidth);
              }
              if (posY <= 0 || posY + logo.clientHeight >= window.innerHeight) {
                  velY *= -1;
                  posY = Math.min(Math.max(posY, 0), window.innerHeight - logo.clientHeight);
              }
...
function ZoomOut(event) {
  ...
  typeMessage(
    `Welcome To JavaSpeak ${nameInputValue}`,
    "welcomeMessage"
  );
...
const questionAndAnswers = {
    ...
    javascript:[
  {
      ...
      answer: "*JavaScript is a lightweight high-level interpreted programming language primarily utilized for scripting webpages. *It is widely used in both front-end and back-end web development to add interactivity and dynamic behavior to websites.",
      keywords: "JavaScript lightweight high level interpreted programming language scripting web pages interactivity and dynamic behaviour"
  },
  {
      // Question 2
      ...
      answer: "*Dynamic typing, prototype-based object-oriented programming, first-class functions, closures, and asynchronous programming with promises and async/await.",
      keywords: "Dynamic typing object-oriented programming first-class functions closures asynchronous programming"
  ...
  },
  {
      ...
      answer: "*Primitive data types: undefined, null, boolean, number, string, symbol. *Non-primitive data type: object.",
      keywords: "Primitive data types: undefined, null, boolean, number, string, symbol. Non-primitive data type: object."
  ...
  },
  {
      ...
      answer: "*Null represents the intentional absence of any value, explicitly indicating that a variable or object does not currently have a value or does not exist. *Undefined indicates that a variable has been declared but hasn't been assigned a value yet.",
      keywords: "absence of any value indicating that a variable or object does not currently have a value or does not exist undefined indicates that a variable has been declared assigned a value yet"
  ...
  },
  {
      ...
      answer: "*The Document Object Model is a programming interface for web documents that represents the structure of an HTML, XML, or SVG document as a tree of objects, allowing dynamic interaction with document content using scripting languages like JavaScript.",
      keywords: "Document Object Model programming interface web represents structure HTML tree of objects"

  },
  {
      // Question 6
      question: "What is the difference between == and ===?",
      questionSpeak: "What is the difference between double equalto and triple equalto?",

      answer: "*The double equalto (==) operator check equality only, whereas triple equalto (===) check equality and data type, meaning a value must be of the same type.",
      keywords: "double equalto triple equalto check checks equality only same data type"
  ...
  },
  {
      ...
      answer: "*Functions are one of the fundamental building blocks in JavaScript. It is a set of statements that perform a task or calculate a value. *We can call function many times to reuse the code with different arguments, to produce different results.",
      keywords: "fundamental building blocks set of statements perform task reuse the code function many times"

  },
  {
      // Question 8
      question: "What is the difference between parameters and arguments in JavaScript?",
      questionSpeak: "What is the difference between parameters and arguments in JavaScript?",

      answer: "*Parameters are variables declared in a function's declaration. *Arguments are the actual values passed to a function when it is called.",
      keywords: "Parameters variables declared function's declaration Arguments actual values passed function called"
  ...
  },
  {
    ...
    answer: "*Var has function scope and can be re-declared within the same scope. *let and const have block scope, and const additionally prevents re-assignment after initialization.",
    keywords: "function scope redeclared same scope var let and const have block scope reassignment"
...
},
{
  ...
  answer: "*Arrow functions are a shorthand syntax for writing function expressions in JavaScript. *They have a more concise syntax compared to traditional function expressions and lexically bind the this value.",
  keywords: "Arrow shorthand syntax for writing function expressions in JavaScript"
...
html: [
    {
        ...
        answer: " *HTML stands for HyperText Markup Language. *It is the standard markup language used to create and design web pages. *HTML describes the structure of a web page using various elements and tags.",
        keywords: "HTML HyperText Markup Language web pages structure elements tags"
    },
    {
        // Question 2
        ...
        answer: " *The main building blocks of HTML are elements. *An HTML element is everything from the start tag to the end tag, including the tags themselves and the content between them.",
    ...
    },
    {
        ...
        answer: " *HTML provides six levels of headings, from <h1> to <h6>. *These headings represent hierarchical structure, with <h1> being the highest level and <h6> being the lowest level.",
    ...
    },
    {
        ...
        answer: " *HTML attributes provide additional information about HTML elements. *They are used to modify the behavior or appearance of an element and provide metadata about the element.",
        keywords: "purpose attributes additional information modify behavior appearance metadata"
    },
    {
        // Question 5
        ...
        answer: " *<div> is a block-level element that represents a division or section in an HTML document. *<span> is an inline-level element used to group inline elements in a document.",
        keywords: "difference block-level element division section inline-level element group inline elements"
    },
    {
        // Question 6
        ...
        answer: " *HTML forms are used to collect user input. *They allow users to input data that can be submitted to a server for processing.",
    ...
    },
    {
        ...
        answer: " *The <a> tag is used to create hyperlinks in HTML documents. *It allows users to navigate between different web pages by clicking on the link.",
    ...
    },
    {
        ...
        answer: " *Semantic HTML elements provide meaning to the content they surround. *They convey information about the structure of the document, making it more accessible to both users and search engines.",
        keywords: "semantic meaning content structure accessible users search engines"
    },
    {
      // Question 9
      ...
      answer: " *The <img> tag is used to insert images into an HTML document. *It specifies the location of the image file using the src attribute and provides alternative text for accessibility using the alt attribute.",
      keywords: "purpose insert images location file src attribute alternative text accessibility alt attribute"
  ...
  },
  {
    ...
    answer: " *The <table> tag is used to create tables in HTML documents. *It allows for the display of tabular data, organized into rows and columns.",
    keywords: "purpose create tables display tabular data organized rows columns"
  ...
  css: [
    {
        ...
        answer: " *CSS stands for Cascading Style Sheets. *It is a style sheet language used to describe the presentation of a document written in HTML or XML, including colors, layout, and fonts.",
    ...
    },
    {
        ...
        answer: " *CSS can be included in a webpage using three methods: *External CSS: linking an external CSS file using the <link> element. *Internal CSS: embedding CSS rules within the <style> element in the <head> section of the HTML document. *Inline CSS: applying CSS styles directly to HTML elements using the style attribute.",
        keywords: "include CSS webpage External CSS linking <link> element Internal CSS embedding <style> element Inline CSS applying styles directly style attribute"
    },
    {
        // Question 3
        ...
        answer: " *CSS selectors are patterns used to select and style HTML elements. *Some common types of CSS selectors include: *Element selectors, Class selectors, ID selectors, Universal selectors, Attribute selectors, and Pseudo-class selectors.",
        keywords: "types selectors patterns select style Element Class ID Universal Attribute Pseudo-class"
    },
    {
        // Question 4
        ...
        keywords: "box model layout design elements Content Padding Border Margin space between"
    },
    {
        // Question 5
        ...
        answer: " *Padding is the space between the content of an element and its border. *Margin is the space outside the border of an element, creating space between the element and other elements.",
    ...
    },
    {
        ...
        answer: " *Media queries in CSS allow for the implementation of responsive design. *They enable the styling of a webpage based on factors such as screen size, device orientation, and resolution.",
        keywords: "purpose implementation responsive design factors screen size device orientation resolution"
    },
    {
        // Question 7
        ...
        answer: " *Pseudo-classes in CSS are keywords that specify a special state of an element. *They are used to define styles for elements in specific situations, such as when a link is hovered over or when an element is the first child of its parent.",
        keywords: "pseudo-classes keywords special state hovered first child parent"
    },
    {
        // Question 8
        question: "What is the difference between margin-collapse and margin-collapse: collapse?",
        questionSpeak: "What is the difference between margin-collapse and margin-collapse: collapse?",
  
        answer: " *margin-collapse is a CSS phenomenon where the top and bottom margins of adjacent elements collapse into a single margin. *margin-collapse: collapse is a CSS property value that explicitly collapses the margins of adjacent elements.",
        keywords: "difference phenomenon adjacent elements collapse property value explicitly"
    },
    {
      // Question 9
      question: "What is the difference between display: none and visibility: hidden?",
      questionSpeak: "What is the difference between display: none and visibility: hidden?",
  
      answer: " *display: none removes the element from the document flow, hiding it completely. *visibility: hidden hides the element, but it still occupies space in the document flow.",
...
const nextQ = () => {
    ...
    if(correctAnsDiv2.textContent == '' || correctAnsDiv2.textContent =='Answer the question'){
        correctAnsDiv2.style.display = 'block';
...
function changeButtonColor(index) {
    ...
    document.querySelector(`.QBtn${index}`).style.backgroundColor = "rgb(109, 226, 255)";
...
let compareAnswers = () => {
    ...
    for (let i = 0; i <= userWords.length; i++) {
        userWords[i];
        let correctWords = questionAndAnswers[selectName][index].keywords.toLowerCase().split(" "); // Split correct answer into words
...
const elementsToHide = document.querySelectorAll('#questionsList, #btn_container, #ans_container, .select_logo');
